...
**Cloud**: AWS
**Cost**: ₹50/user/month  
**Performance**: Instant response, High ML accuracy
...
- **Open Search**: Vector database
- **Timestream**: Farmer Market (Mandi) prices time-series
...
- **Intent Classifier**: IndicBERT fine-tuned for Hindi
...
- Accuracy: high accuracy for diseases
- Inference: <3s on SageMaker ml.g4dn.xlarge (GPU)

**Knowledge Graph** (Neptune):
- Villages → crops → varieties → practices
...
|-------|---------|-----------|
| **Disease Detection** | Crop disease ID | PyTorch | 
| **Price Forecasting** | Mandi price prediction | LSTM + Prophet |
| **Intent Classification** | User intent | IndicBERT (Hindi) |
| **Voice Transcription** | Speech-to-text | AWS Transcribe |

## 6. Infrastructure

### Compute
- **ECS**: 2-20 tasks (2 vCPU, 4GB each)
